...
const VFPEnc VFPOps[][2] = {
	...
	{{0xE1, 0xA4}, {  -1,   -1}}, // 0: VNMLA
	{{0xE0, 0xA4}, {0x22, 0xD1}}, // 1: VMLS
	{{0xE1, 0xA0}, {  -1,   -1}}, // 1: VNMLS
	{{0xE3, 0xA0}, {0x20, 0xD0}}, // 2: VADD
	{{0xE3, 0xA4}, {0x22, 0xD0}}, // 3: VSUB
	{{0xE2, 0xA0}, {0x30, 0xD1}}, // 4: VMUL
	{{0xE2, 0xA4}, {  -1,   -1}}, // 5: VNMUL
	{{0xEB, 0xAC}, {  -1 /* 0x3B */,  -1 /* 0x70 */}}, // 6: VABS(Vn(0x0) used for encoding)
	{{0xE8, 0xA0}, {  -1,   -1}}, // 7: VDIV
	{{0xEB, 0xA4}, {  -1 /* 0x3B */,   -1 /* 0x78 */}}, // 8: VNEG(Vn(0x1) used for encoding)
	{{0xEB, 0xAC}, {  -1,   -1}}, // 9: VSQRT (Vn(0x1) used for encoding)
	{{0xEB, 0xA4}, {  -1,   -1}}, // 10: VCMP (Vn(0x4 | #0 ? 1 : 0) used for encoding)
	{{0xEB, 0xAC}, {  -1,   -1}}, // 11: VCMPE (Vn(0x4 | #0 ? 1 : 0) used for encoding)
	{{  -1,   -1}, {0x3B, 0x30}}, // 12: VABSi
	};
